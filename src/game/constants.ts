...
export const COLORS = {
  ...
  gang1: '#ff2d8a', gang2: '#00f0ff', gang3: '#39ff14', gang4: '#b56cff',
...
export const GANG_NAMES: Record<string, string> = { loons: 'Психи (розовые)', yutes: 'Южные (голубые)', russians: 'Братва (зеленые)', triads: 'Триады (фиолетовые)', none: 'Нейтралы' };
export const GANG_COLORS: Record<string, string> = { loons: COLORS.gang1, yutes: COLORS.gang2, russians: COLORS.gang3, triads: COLORS.gang4, none: '#888888' };
